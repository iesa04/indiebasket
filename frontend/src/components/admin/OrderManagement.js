...
const OrderManagement = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch('https://indiebasket.onrender.com/api/admin/orders', {
          credentials: 'include'
        });
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
      const response = await fetch(`https://indiebasket.onrender.com/api/admin/orders/${orderId}/status`, {
        method: 'PATCH',
