...
const ProductManagement = () => {
    ...
    const fetchData = async () => {
      try {
        const [productsRes, categoriesRes] = await Promise.all([
          fetch('https://indiebasket.onrender.com/api/products', { credentials: 'include' }),
          fetch('https://indiebasket.onrender.com/api/categories')
        ]);
  ...
  const handleCreateProduct = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://indiebasket.onrender.com/api/products', {
        method: 'POST',
  ...
  const handleUpdateProduct = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://indiebasket.onrender.com/api/products/${currentProduct._id}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
  ...
  const handleToggleStatus = async (id, field) => {
    try {
      ...
      const response = await fetch(`https://indiebasket.onrender.com/api/products/${id}`, {
        method: 'PATCH',
        headers: { 'Content-Type': 'application/json' },
        credentials: 'include',
        body: JSON.stringify({ 
