    ...
    const fetchStats = async () => {
      try {
        const responses = await Promise.all([
          ...
          fetch('http://localhost:5000/api/products/count', { credentials: 'include' }),
          fetch('http://localhost:5000/api/categories/count', { credentials: 'include' }),
          fetch('http://localhost:5000/api/admin/orders/count', { credentials: 'include' }),
          fetch('http://localhost:5000/api/promotions/count', { credentials: 'include' })
        ]);
